...
public final class DatePickerWheelView extends LinearLayout {
    ...
    private void drawDatePickerWheelView() {
        ...
        yearSpinner.addOnLoopScrollListener(new WheelView.OnLoopScrollListener() {
            @Override
            public void onLoopScrollFinish(@NonNull Object item, int position) {
                updateYearPosition(item,position);
            }
        });
        yearSpinner.addOnLoopScrollListener(new WheelView.OnLoopScrollListener() {
            @Override
            public void onLoopScrollFinish(@NonNull Object item, int position) {
                onDateSelected(item,position);
            }
        });

        monthSpinner.addOnLoopScrollListener(new WheelView.OnLoopScrollListener() {
            @Override
            public void onLoopScrollFinish(@NonNull Object item, int position) {
                updateMonthPosition(item,position);
            }
        });
        monthSpinner.addOnLoopScrollListener(new WheelView.OnLoopScrollListener() {
            @Override
        ...
        daySpinner.addOnLoopScrollListener(new WheelView.OnLoopScrollListener() {
            @Override
            public void onLoopScrollFinish(@NonNull Object item, int position) {
                updateDayPosition(item,position);
            }
        });
        daySpinner.addOnLoopScrollListener(new WheelView.OnLoopScrollListener() {
            @Override
